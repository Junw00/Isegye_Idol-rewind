...
function changeInfo(direction) {
	...
	function swapInfosClass() {
		...
		$.each(people, function (index, el) {
			var _this = $(el);
			if (_this.hasClass('current--card')) {
				count = 1
				player.unMute()
				player2.mute()
				player3.mute()
			} else if (_this.hasClass('previous--card')) {
				count = 0
				player.mute()
				player2.unMute()
				player3.mute()
			} else if (_this.hasClass('next--card')) {
				count = 2
				player.mute()
				player2.mute()
				player3.unMute()
...
function onYouTubeIframeAPIReady() {
	...
	player2 = new YT.Player('player2', { //2
		height: '315',
		width: '560',
		videoId: 'IV6hYr_9a38',
		events: {
	...
	player3 = new YT.Player('player3', { //0
		height: '315',
		width: '560',
		videoId: 'dzQ88ZJStWc',
		events: {
